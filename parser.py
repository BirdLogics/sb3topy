...
class Parser:
    ...
    def get_fields(self, block):
        ...
        for field, value in block.get('fields', "").items():
            ...
            # Characters added here may be stripped by identifier cleaning
    ...
    def get_blockmap(self, blockid, parameters):
        ...
        #     mutation = self.blocks[block['inputs']['custom_block'][1]]['mutation']
    ...
    def parse_input(self, block, blockmap, inp):
        ...
        # Broadcast
            ...
            value = quote_string(
                self.broadcasts.get_existing("broadcast_" + value[1]))
...
class Identifiers:
    ...
    def get_existing(self, specific):
        """
